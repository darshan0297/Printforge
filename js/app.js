...
const DEMO_PRODUCTS = [
  ...
  // ── 3D Printers ──
  { id:'pr1', name:'Creality Ender 3 V3 SE', category:'3D Printers', price:42000, old_price:48000, description:'Beginner-friendly FDM printer with a direct drive extruder, automatic bed leveling, and fast printing right out of the box. A great first printer for cosplay props, prototypes, and hobby prints.', stock:8, icon:'🖨️', featured:true, tag:'Popular', specs:{technology:'FDM (Fused Deposition Modeling)',build_volume:'220 × 220 × 250 mm',extruder_type:'Direct drive',nozzle_diameter:'0.4mm',max_hotend_temp:'260°C',max_bed_temp:'100°C',max_print_speed:'250mm/s',layer_resolution:'0.05 – 0.35mm',auto_leveling:'Yes — automatic bed leveling',connectivity:'USB, microSD',filament_compatibility:'PLA, PETG, TPU',display:'4.3" touchscreen',frame:'Open-frame Cartesian'} },
  { id:'pr2', name:'Creality K1C — Enclosed CoreXY', category:'3D Printers', price:98000, old_price:110000, description:'High-speed enclosed CoreXY printer built for reliability and speed. Ideal for tougher engineering materials like ABS and ASA — great for functional parts and durable cosplay armour.', stock:4, icon:'🖨️', featured:true, tag:'Deal', specs:{technology:'FDM (Fused Deposition Modeling)',build_volume:'220 × 220 × 250 mm',extruder_type:'Direct drive, dual-gear',nozzle_diameter:'0.4mm (interchangeable)',max_hotend_temp:'300°C',max_bed_temp:'110°C',max_print_speed:'600mm/s',layer_resolution:'0.05 – 0.35mm',auto_leveling:'Yes — full-bed mesh, strain gauge',connectivity:'Wi-Fi, USB, microSD, companion app',filament_compatibility:'PLA, PETG, ABS, ASA, TPU, PA-CF',filament_sensor:'Yes — auto pause & resume',power_recovery:'Yes — resumes after outage',frame:'Enclosed CoreXY',camera:'Built-in — live view & timelapse'} },
  { id:'pr3', name:'Elegoo Mars 5 Ultra — Resin Printer', category:'3D Printers', price:65000, old_price:null, description:'High-resolution MSLA resin printer for ultra-detailed miniatures, cosplay accessories, and jewellery masters. Mono LCD panel with fast curing times.', stock:6, icon:'🖨️', featured:false, tag:'In Stock', specs:{technology:'MSLA (Resin / LCD)',build_volume:'153.4 × 77.8 × 165 mm',xy_resolution:'19 microns',light_source:'COB UV LED array (405nm)',layer_resolution:'0.01 – 0.2mm',max_print_speed:'up to 150mm/hr',screen:'10.3" 9K mono LCD',connectivity:'USB',resin_compatibility:'Standard, ABS-like, water-washable resin',display:'5" colour touchscreen'} },
  ...
  <footer>
    <div class="footer-grid">
      ...
      <div class="footer-col">
        <h5>Shop</h5>
        <a href="/shop?cat=3D Printers">3D Printers</a>
